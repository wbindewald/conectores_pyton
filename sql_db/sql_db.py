...
jdbc_url = '{jdbc_url}'""")
  ...
  def _get_read_connection(self, db_type=None, db_domain=None, db_name=None, username=None, password=None, jdbc_url=None):
    if db_type == None:
  ...
  def read_query(self, query_string, db_type=None, db_domain=None, db_name=None, username=None, password=None, jdbc_url=None):
    query_conn = self._get_read_connection(db_type, db_domain, db_name, username, password, jdbc_url)
  ...
  def get_full_table(self, table_name, db_type=None, db_domain=None, db_name=None, username=None, password=None, jdbc_url=None):
    table_conn = self._get_read_connection(db_type, db_domain, db_name, username, password, jdbc_url)
